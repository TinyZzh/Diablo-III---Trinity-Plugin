...
namespace Trinity.Framework.Helpers
{
    public static class Internals
    {
        ...
        private static class DemonBuddyOffsets
        {
            ...
            public static IntPtr SNOGroups => (IntPtr)0x01C12C90; //_offsetsC.ElementAtOrDefault(12) + 0x38;
            public static IntPtr AttributeDescripter => (IntPtr)0x01C65660; //_offsetsC.ElementAtOrDefault(15) - 0x04;
