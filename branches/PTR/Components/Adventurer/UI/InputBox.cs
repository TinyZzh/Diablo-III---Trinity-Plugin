...
namespace Trinity.Components.Adventurer.UI
{
    ...
    public class InputBox
    {
        ...
        private static void InitializeComponent()
        {
            ...
            frmInputDialog.KeyDown += FrmInputDialog_KeyDown;
        ...
        private static void TxtInput_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private static void FrmInputDialog_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Escape)
            {
                OutputResponse.ReturnCode = DialogResult.Cancel;
