...
//            public bool HasCurrency(Dictionary<InventoryItemType, int> recipe, InventorySlot location)
//            {
...
//            if (i.IsUnidentified && Core.Settings.Items.KeepLegendaryUnid)
//                return false;
...
//        {
//            public static long OrganDiablo
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganDiablo);
//            public static long OrganLeoric
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganSkeletonKing);
//            public static long OrganGhom
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganGhom);
//            public static long OrganSiegeBreaker
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganSiegeBreaker);
//            public static long OrganEye
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganEye);
//            public static long DemonOrganSpineCord
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DemonOrganSpineCord);
//            public static long Gold
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.Gold);
//            public static long BloodShards
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.BloodShards);
//            public static long ArcaneDust
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.ArcaneDust);
//            public static long ReusableParts
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.ReusableParts);
//            public static long VeiledCrystals
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.VeiledCrystal);
//            public static long DeathsBreath
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.DeathsBreath);
//            public static long ForgottenSoul
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.ForgottenSoul);
//            public static long CaldeumNightshade
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.CaldeumNightshade);
//            public static long WestmarchHolyWater
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.WestmarchHolyWater);
//            public static long ArreatWarTapestry
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.ArreatWarTapestry);
//            public static long CorruptedAngelFlesh
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.CorruptedAngelFlesh);
//            public static long KhanduranRune
//                => ZetaDia.Storage.PlayerDataManager.ActivePlayerData.GetCurrencyAmount(CurrencyType.KhanduranRune);
//        }
